...
pub fn sphere(comptime iterations: u32) type {
    ...
    const Mesh = struct {
        ...
        pub fn init(self: *@This()) void {
            ...
            self.indices[0] = Triangle{ .v1 = 0, .v2 = 5, .v3 = 11 };
            self.indices[1] = Triangle{ .v1 = 0, .v2 = 1, .v3 = 5 };
            self.indices[2] = Triangle{ .v1 = 0, .v2 = 7, .v3 = 1 };
            self.indices[3] = Triangle{ .v1 = 0, .v2 = 10, .v3 = 7 };
            self.indices[4] = Triangle{ .v1 = 0, .v2 = 11, .v3 = 10 };

            self.indices[5] = Triangle{ .v1 = 1, .v2 = 9, .v3 = 5 };
            self.indices[6] = Triangle{ .v1 = 5, .v2 = 4, .v3 = 11 };
            self.indices[7] = Triangle{ .v1 = 11, .v2 = 2, .v3 = 10 };
            self.indices[8] = Triangle{ .v1 = 10, .v2 = 6, .v3 = 7 };
            self.indices[9] = Triangle{ .v1 = 7, .v2 = 8, .v3 = 1 };

            self.indices[10] = Triangle{ .v1 = 3, .v2 = 4, .v3 = 9 };
            self.indices[11] = Triangle{ .v1 = 3, .v2 = 2, .v3 = 4 };
            self.indices[12] = Triangle{ .v1 = 3, .v2 = 6, .v3 = 2 };
            self.indices[13] = Triangle{ .v1 = 3, .v2 = 8, .v3 = 6 };
            self.indices[14] = Triangle{ .v1 = 3, .v2 = 9, .v3 = 8 };

            self.indices[15] = Triangle{ .v1 = 4, .v2 = 5, .v3 = 9 };
            self.indices[16] = Triangle{ .v1 = 2, .v2 = 11, .v3 = 4 };
            self.indices[17] = Triangle{ .v1 = 6, .v2 = 10, .v3 = 2 };
            self.indices[18] = Triangle{ .v1 = 8, .v2 = 7, .v3 = 6 };
            self.indices[19] = Triangle{ .v1 = 9, .v2 = 1, .v3 = 8 };
